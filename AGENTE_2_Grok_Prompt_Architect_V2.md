# AGENTE 2 V2 - Grok Prompt Architect PRO
...
#### 1. CHARACTER (se presente persona)
...
- **Aspetto**: Generico ma credibile per contesto
  - Tech rant → casual wear, everyday look
  - Tutorial → professional attire or work clothes
  - Dramatic → appropriate to situation
...
**Determina CHARACTER (se persona):**
...
**Aggiungi dettagli generici credibili:**
...
| "facial expression", "eyes reaction" | Close-up |
| "hand precision", "micro detail" | Extreme close-up / Macro |
| "full body", "physical effort" | Medium shot |
...
ACTION: Man taps touchscreen, €19.99 popup appears, eyes widen
[EMPHASIS: popup must be readable, glow brightly]

INFERENZA:
- CHARACTER: 40-50yo man, everyday relatable, casual wear (tech rant context)
- CAMERA: Medium close-up (popup readable + face reaction), eye level, static
- SETTING: Car interior (touchscreen), glowing screen (EMPHASIS)
...
**INFERENZA AGENTE 2:**
- **CHARACTER**: 45yo man, everyday relatable (tech rant context), casual wear
- **CAMERA**: Medium close-up (popup readable + face), eye level, static locked
...
**INFERENZA AGENTE 2:**
- **CHARACTER**: N/A (solo mani, off-screen narrator)
